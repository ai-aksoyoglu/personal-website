...
const main = async function () {
  ...
  await apple.save().then(() => console.log('A fruit was added.'));
  ...
  await person.save().then(() => console.log('A person was added.'));
  ...
  await Fruit.insertMany([kiwi, orange, banana], function (err) {
    if (err) {
      console.log(err);
    } else {
